"""The Pommerman v4 smaller training environment.
...
class Pomme(gym.Env):
    ...
    def __init__(self,
        ...
        self._free_board_size = free_board_size
    ...
    def make_board(self):
        ...
        self._board = utility.make_board_small(self._board_size, self._free_board_size, 
                                               self._num_rigid, self._num_wood, len(self._agents))
